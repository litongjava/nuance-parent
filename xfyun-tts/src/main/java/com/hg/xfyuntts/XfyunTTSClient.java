...
public class XfyunTTSClient {
	...
	public static void main(String[] args) {
		...
		// XfyunTTSClient.toFile(text, "./prompt.pcm", "8000");

		/*
		 * 合成一段自我介绍
		 */
		String text = "我的名字是李通,我是合光机器人的的java开发工程师,我的名字是李通.我是合光机器人的java开发工程师";
		String pcmFile = "pcm/iamlitong.pcm";
		String wavFile = "wav/iamlitong.wav";
		String sampleRate = "8000";
		// XfyunTTSClient.toFile(text, pcmFile, sampleRate);
		// // 合成需要一段时间,合成时间无法确定,需要单独转换
		// try {
		// Thread.sleep(10000);
		// } catch (InterruptedException e) {
		// e.printStackTrace();
		// }
		WavUtilImplCommon.pcmToWav(pcmFile, wavFile, Integer.valueOf(sampleRate));
	}
